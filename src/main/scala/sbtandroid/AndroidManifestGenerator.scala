...
import AndroidPlugin.generateManifest
import AndroidPlugin.manifestPath
import AndroidPlugin.manifestRewriteRules
import AndroidPlugin.manifestTemplateName
import AndroidPlugin.manifestTemplatePath
import AndroidPlugin.versionCode
